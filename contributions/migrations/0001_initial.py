    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('PAID', 'Paid'), ('LATE', 'Late'), ('MISSED', 'Missed'), ('REVERSED', 'Reversed')], default='PENDING', max_length=10)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('badge_type', models.CharField(choices=[('STREAK_3', '3-Month Streak 🔥'), ('STREAK_6', '6-Month Streak ⭐'), ('STREAK_12', '12-Month Streak 🏆')], max_length=20)),
